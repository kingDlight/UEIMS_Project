...
This project is indexed by GitNexus as **UEIMS_Project** (1931 symbols, 3964 relationships, 28 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Service area (83 symbols) | `.claude/skills/generated/service/SKILL.md` |
| Work in the Exception area (9 symbols) | `.claude/skills/generated/exception/SKILL.md` |
