...
import { TrendingUp, GraduationCap, Building2, Users } from "lucide-react";
    ...
    >
      ...
      {payload.map((entry, i) => (
        ...
        >
          ...
          />
          <span
            style={{ fontSize: 12.5, color: cc.textSecondary, fontWeight: 500 }}
          >
            {entry.name}
          </span>
          <span
      ...
      render: (v: number) => (
        <span
          style={{
            fontSize: 13,
            fontWeight: 700,
            color: v < 2.5 ? cc.warning : cc.textPrimary,
            fontFamily: "Inter, sans-serif",
            fontVariantNumeric: "tabular-nums",
          }}
        >
    ...
    >
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <p style={{ fontSize: 13, color: cc.textMuted, margin: "4px 0 0" }}>
          OJT placement performance, GPA distribution, and enterprise
          participation
        </p>
      </div>
      ...
      >
        <MetricCard
          ...
          value={overallRate}
          suffix="%"
          icon={<TrendingUp size={20} color={cc.success} />}
          color={cc.success}
        ...
        <MetricCard
          ...
          label="Avg GPA"
          value="3.2"
          icon={<GraduationCap size={20} color={cc.info} />}
          color={cc.info}
        ...
        <MetricCard
          ...
          value={124}
          icon={<Building2 size={20} color={cc.brand} />}
          color={cc.brand}
          bgMuted={cc.brandMuted}
        />
        <MetricCard
          index={3}
          ...
          value="92"
          suffix="%"
          icon={<Users size={20} color={cc.warning} />}
          color={cc.warning}
      ...
      <div ref={containerRef} className="stats-charts-grid">
        ...
        >
          ...
          <div style={{ fontSize: 12, color: cc.textMuted, marginBottom: 20 }}>
            Placed vs. still searching — current semester
          </div>
          ...
          <div
            style={{ display: "flex", gap: 20, marginTop: 8, padding: "0 8px" }}
          >
            {PLACEMENT_DATA.map((entry) => (
              <div
                key={entry.name}
        ...
        >
          ...
          <div style={{ fontSize: 12, color: cc.textMuted, marginBottom: 16 }}>
            Average GPA distribution across majors
          </div>
          <div style={{ height: 220, minHeight: 0, paddingRight: 24 }}>
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                />
                <Tooltip
                  content={<CustomTooltip unit=" GPA" />}
                  cursor={{ fill: cc.brandSubtle, radius: 6 }}
                />
                <Bar
                  dataKey="avgGpa"
      ...
      >
        ...
        >
          <div>
            ...
            >
              Monthly placement progress — current academic year
            </div>
          </div>
          <div style={{ display: "flex", gap: 16 }}>
            {[
              { label: "Placed", color: cc.success },
              { label: "Searching", color: cc.warning },
            ].map(({ label, color }) => (
              <div
                key={label}
      ...
      >
        ...
        >
          ...
          >
            OJT placement rates and GPA averages across all majors — AY
            2025–2026
          </div>
        </div>
        <Table
