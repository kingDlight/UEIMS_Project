...
export const HeroSection = ({ isDark, handleMouseMove, spotlightRef, scrollToSection }: any) => {
  ...
  return (
    <section
      ...
      className={`relative pt-36 pb-20 md:pt-48 md:pb-32 px-6 md:px-12 flex items-center justify-center overflow-hidden z-10 border-b transition-colors duration-300 ease-in-out ${isDark ? 'border-zinc-900' : 'border-slate-200'
        }`}
    >
      <div
        ref={spotlightRef}
        ...
        style={{
          background: `radial-gradient(700px circle at var(--mouse-x, 50%) var(--mouse-y, -20%), ${isDark ? 'rgba(243, 112, 33, 0.07)' : 'rgba(243, 112, 33, 0.18)'
            }, transparent 80%)`
        }}
      ></div>
      ...
      >
        <div className={`animate-fade-in-up [animation-delay:0ms] inline-flex items-center gap-2 px-3 py-1.5 rounded-full border mb-8 transition-colors duration-300 ease-in-out ${isDark ? 'bg-[#f37021]/10 border-[#f37021]/30' : 'bg-[#f37021]/5 border-[#f37021]/20'
          }`}>
        ...
        <h1 className={`animate-fade-in-up [animation-delay:100ms] text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight leading-none mb-6 transition-colors duration-300 ease-in-out ${isDark ? 'text-white' : 'text-slate-900'
          }`}>
          {t('home.hero.title1')}
          <br />
        ...
        <p className={`animate-fade-in-up [animation-delay:200ms] text-base sm:text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed font-normal transition-colors duration-300 ease-in-out ${isDark ? 'text-zinc-300' : 'text-black font-medium'
          }`}>
        ...
        <div className="animate-fade-in-up [animation-delay:300ms] flex gap-4 justify-center flex-wrap mb-20">
          ...
          <button
            ...
            className={`text-sm font-semibold bg-transparent px-7 py-3.5 rounded-full border transition-all duration-300 ease-in-out ${isDark ? 'text-zinc-100 border-zinc-500 hover:text-white hover:bg-zinc-800/40 hover:border-zinc-400' : 'text-slate-800 border-slate-400 hover:text-[#f37021] hover:bg-slate-100 hover:border-[#f37021]'
              }`}
          >
        ...
        <div className={`animate-fade-in-up [animation-delay:400ms] grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 pt-10 backdrop-blur-md rounded-2xl p-6 border transition-all duration-300 ease-in-out ${isDark ? 'border-zinc-800/30 bg-[#0e1322]/30 text-zinc-100' : 'border-slate-200 bg-white/85 shadow-lg shadow-slate-100/40 text-slate-800'
          }`}>
