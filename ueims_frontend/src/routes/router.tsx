...
const TrainingManagerDashboard = React.lazy(() =>
  import('@/pages/TrainingManagerDashboard').then((m) => ({ default: m.TrainingManagerDashboard })),
);
const StudentDashboard = React.lazy(() =>
  import('@/pages/student/StudentDashboard').then((m) => ({ default: m.StudentDashboard })),
);
const EnterpriseDashboard = React.lazy(() =>
  import('@/pages/enterprise/EnterpriseDashboard').then((m) => ({ default: m.EnterpriseDashboard })),
);
const AdminDashboard = React.lazy(() =>
  import('@/pages/admin/AdminDashboard').then((m) => ({ default: m.AdminDashboard })),
);
const JobDetailPage = React.lazy(() =>
  import('@/pages/student/JobDetailPage').then((m) => ({ default: m.JobDetailPage })),
);
