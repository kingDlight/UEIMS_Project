...
public interface PlacementApplicationRepository extends JpaRepository<PlacementApplication, UUID> {
    ...
    List<PlacementApplication> findByStatusAndSemester(@Param("status") String status,
    ...
    boolean existsActiveAssignmentForStudentInSemester(@Param("studentId") UUID studentId,
                                                       @Param("semesterId") UUID semesterId);
}