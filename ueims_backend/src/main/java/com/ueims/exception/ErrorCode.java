...
public enum ErrorCode {
    ...
    JOB_POST_NEGATIVE_POSITIONS(
            1111, "Open positions cannot be negative. Use 0 to close new applications.", HttpStatus.BAD_REQUEST),
    ...
    RESOURCE_INVALID_STATE(1088, "Resource is not in a valid state for this operation", HttpStatus.CONFLICT),
