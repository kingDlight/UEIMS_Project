...
public class GlobalExceptionHandler {
        ...
        ResponseEntity<ApiResponse<Void>> handlingHttpRequestMethodNotSupportedException(
                ...
                return ResponseEntity.status(errorCode.getStatusCode())
                                .body(ApiResponse.<Void>builder()
                                                .code(errorCode.getCode())
                                                .message(errorCode.getMessage().replace("{method}",
                                                                exception.getMethod()))
                                                .build());
        }
        ...
        ResponseEntity<ApiResponse<Void>> handlingAppException(AppException exception) {
                ...
                apiResponse.setMessage(exception.getMessage() != null && !exception.getMessage().isEmpty()
                                ? exception.getMessage()
                                : errorCode.getMessage());
        ...
        ResponseEntity<ApiResponse<Void>> handlingMissingParameter(
                ...
                return ResponseEntity.status(errorCode.getStatusCode())
                                .body(ApiResponse.<Void>builder()
                                                .code(errorCode.getCode())
                                                .message(errorCode.getMessage().replace("{param}",
        ...
        ResponseEntity<ApiResponse<Void>> handlingTypeMismatch(
                ...
                String requiredType = exception.getRequiredType() != null
                                ...
                                : "Unknown";
                String message = errorCode.getMessage().replace("{param}", exception.getName()).replace("{type}",
                                requiredType);
        ...
        ResponseEntity<ApiResponse<Void>> handlingValidation(MethodArgumentNotValidException exception) {
                ...
                String firstFieldMessage = exception.getFieldError() != null
                ...
                if (hasBlankOrNullFailure) {
                        ...
                        apiResponse.setMessage(
                                        Objects.nonNull(attributes)
                                                        ...
                                                        : (firstFieldMessage != null ? firstFieldMessage
                                                                        : errorCode.getMessage()));
                }
