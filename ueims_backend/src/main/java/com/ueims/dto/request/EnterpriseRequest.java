...
public class EnterpriseRequest {
    ...
    @Size(max = 50, message = "Tax code must not exceed {max} characters")
    ...
    @Size(max = 5000, message = "Description must not exceed {max} characters")
    ...
    @Size(max = 255, message = "Contact person must not exceed {max} characters")
    private String contactPerson;

    @NotBlank(message = "Contact phone is required")
    @Size(max = 20, message = "Contact phone must not exceed {max} characters")
    @Pattern(regexp = "^[+0-9\\-\\s()]{6,20}$", message = "Contact phone has invalid format")
    private String contactPhone;

    @NotBlank(message = "Contact email is required")
    @Email(message = "Contact email must be a valid email address")
    @Size(max = 255, message = "Contact email must not exceed {max} characters")
