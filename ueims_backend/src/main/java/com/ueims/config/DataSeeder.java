        ...
        enterpriseRepository.findAll().forEach(e -> {
            if (Arrays.asList("FPT Software", "VNG Corporation", "NashTech Vietnam", "TMA Solutions")
                ...
                for (var assignment : assignments) {
                    ...
                    finalReportRepository.findByAssignment_AssignmentId(assignmentId)
                            .ifPresent(fr -> {
                    ...
                    enterpriseEvaluationRepository.findByAssignment_AssignmentId(assignmentId)
                            .ifPresent(ee -> {
                ...
                log.info("Deleted {} student_enterprise_feedbacks for enterprise ID: {}", feedbacks.size(), enterpriseId);
