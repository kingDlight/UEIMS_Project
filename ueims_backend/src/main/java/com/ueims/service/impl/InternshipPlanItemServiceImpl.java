...
public class InternshipPlanItemServiceImpl implements InternshipPlanItemService {
    ...
    @Override
    public List<InternshipPlanItem> findAll() { return repository.findAll(); }

    @Override
    public InternshipPlanItem findById(UUID id) { return repository.findById(id).orElse(null); }

    @Override
    public InternshipPlanItem save(InternshipPlanItem entity) { return repository.save(entity); }
