...
public class SemesterEnterpriseServiceImpl implements SemesterEnterpriseService {
    ...
    @Override
    public SemesterEnterprise findById(SemesterEnterpriseId id) { return repository.findById(id).orElse(null); }

    @Override
    public SemesterEnterprise save(SemesterEnterprise entity) { return repository.save(entity); }

    @Override
    public void deleteById(SemesterEnterpriseId id) { repository.deleteById(id); }
}
