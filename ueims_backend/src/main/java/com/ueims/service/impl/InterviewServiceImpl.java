...
public class InterviewServiceImpl implements InterviewService {
    ...
    private void autoCreatePlacementAfterInterview(Interview interview) {
        ...
        // Auto clone internship plan if there is an approved master plan for this
        // JobPost
        ...
        if (!masterPlans.isEmpty()) {
            ...
            if ("APPROVED".equals(masterPlan.getStatus())) {
                ...
                List<InternshipPlanItem> masterItems = internshipPlanItemRepository
                        .findByPlan_PlanId(masterPlan.getPlanId());
