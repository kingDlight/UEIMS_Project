...
public class ReportFeedbackServiceImpl implements ReportFeedbackService {
    ...
    @Override
    public List<ReportFeedback> findAll() { return repository.findAll(); }

    @Override
    public ReportFeedback findById(UUID id) { return repository.findById(id).orElse(null); }

    @Override
    public ReportFeedback save(ReportFeedback entity) { return repository.save(entity); }
