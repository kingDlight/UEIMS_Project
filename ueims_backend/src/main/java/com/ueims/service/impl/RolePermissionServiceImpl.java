...
public class RolePermissionServiceImpl implements RolePermissionService {
    ...
    @Override
    public RolePermission findById(RolePermissionId id) { return repository.findById(id).orElse(null); }

    @Override
    public RolePermission save(RolePermission entity) { return repository.save(entity); }

    @Override
    public void deleteById(RolePermissionId id) { repository.deleteById(id); }
}
